...
-   PhenotypeR 0.5 is available in [CRAN](https://cran.r-project.org/web/packages/PhenotypeR/index.html){.link}.
...
See the example app provided with the training materials.
...
## Extra: Changing additional parameters

. . .

-   Modify extra parameters (*window, eventInWindow, episodesInWindow* for the LSC) using global variables:
...
## Extra: Adding context to your results via data source description

-   Visit [Data source description shiny app](https://dpa-pde-oxford.shinyapps.io/PhenotypeDataSourceDescriptionsShiny/)

. . .

![](Figures/website_data_source.png)
...
![](Figures/data_source_description.png)

## Extra: Adding context to your results via clinical descriptions

-   Visit [Clinical Descriptions shiny app](https://dpa-pde-oxford.shinyapps.io/PhenotypeDescriptionsShiny/)

. . .

![](Figures/website_clinical.png)
...
![](Figures/ClinicalDescription.png)
